          ...
          <!-- ENTRADA PARA EL CÓDIGO --> 
           ...
           <div class="form-group">
             ...
             <div class="input-group">
               ...
               <input type="text" class="form-control input-group-lg" id="nuevoCodigo"  name="nuevoCodigo" placeholder="Ingresar código" readonly required>
            ...
            <div class="col-xs-12 col-sm-6">
              ...
              <div class="col-xs-12 col-sm-6">
                 ...
                 <span class="input-group-addon"><i class="fa fa-arrow-down"></i></span>
                  ...
                  <input type="number" class="form-control input-group-lg" id="editarPrecioVenta"  name="editarPrecioVenta" min="0" step="any" readonly required>
