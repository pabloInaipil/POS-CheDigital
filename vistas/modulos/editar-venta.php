                      ...
                      <tr>
                        <td style="width: 50%">
                          ...
                          <div class="input-group">
                            ...
                            <input type="number" class="form-control input-lg" min="0" id="nuevoImpuestoVenta" value="<?php echo $porcentajeImpuesto; ?>"  name="nuevoImpuestoVenta" placeholder="0" required>
